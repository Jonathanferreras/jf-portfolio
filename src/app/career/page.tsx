                  ...
                  <div className="bg-transparent border border-white/40 p-6 rounded-lg shadow-md w-full md:w-[90%] transition-all duration-300">
                    ...
                    {job.link && (
                      <a
                        ...
                        className="group flex items-center w-fit border border-[color:var(--foreground)] text-[color:var(--foreground)] hover:bg-[color:var(--accent)] hover:text-black hover:border-[color:var(--background)] transition-colors px-4 py-2 rounded-full text-sm font-medium"
                      >
                        Visit Website{" "}
